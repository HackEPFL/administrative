...
\hfil{\huge \bf Invoice - Hackers @ EPFL}\hfil % Company providing the invoice
...
\\ \\
{ \bf Invoice To:} \\
\tab Partner Name \\ % Invoice recipient
\tab Partner Address \\ % Recipient's company
...
\feetype{Food} % Fee category description

\feerow{Web Hosting: October, 2012}{60}

%------------------------------------------------

\feetype{Other} % Fee category description
